# Sri Lanka Expert · Version 12.8.3
...
Version 12.8.2 changes the default Hotel Management order so the most recently created hotel is always displayed at the top of the list.

Version 12.8.3 expands Hotel Management search to hotel names, destination, region, country, classification, market segment, supplier, SLTDA registration, star rating, database ID and creation date. Multi-word searches match each word independently, and search can be combined with country and status filters.
