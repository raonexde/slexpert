...
## Aktualisierung auf Version 12.8.3

1. Datenbank und Website-Dateien sichern.
2. Die Dateien aus Version 12.8.3 über die bisherigen Programmdateien kopieren. Vorhandene `config.local.php`, Uploads und gespeicherte Dokumente nicht löschen.
...
Version 12.8.2 zeigt in der Hotelverwaltung das zuletzt angelegte Hotel automatisch an erster Stelle. Dafür ist keine Datenbankänderung erforderlich.

Version 12.8.3 erweitert die Hotelsuche und ergänzt eine Zurücksetzen-Schaltfläche. Dafür ist ebenfalls keine Datenbankänderung erforderlich.
